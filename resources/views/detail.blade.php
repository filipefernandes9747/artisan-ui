...
@php
    /** @var Lorisleiva\ArtisanUI\Command $command */
@endphp
@php
    /** @var Lorisleiva\ArtisanUI\CommandArgument $argument */
@endphp
@php
    /** @var Lorisleiva\ArtisanUI\CommandOption $option */
@endphp
...
@section('content')
    <div x-data="command">
        ...
        <div class="flex space-x-8 items-center">
            <button class="relative px-6 py-2 bg-gray-700 text-white rounded" :disabled="state === 'loading'"
                @click="execute">
                <div x-show="state === 'loading'" x-cloak
                    class="absolute inset-0 bg-gray-500 text-white rounded flex items-center justify-center cursor-not-allowed">
        ...
        <div x-cloak x-show="state === 'success' || state === 'error'">
            <pre class="overflow-x-auto mt-16 bg-gray-700 text-white rounded p-8" x-text="output"></pre>
            <div class="flex justify-end mt-1">
                <button class="text-xs font-semibold text-gray-400 hover:text-gray-600 hover:underline"
